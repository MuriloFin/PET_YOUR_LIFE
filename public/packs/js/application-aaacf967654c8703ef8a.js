    ...
    value: function selectPet() {
      if (this.petSelectTarget.value == "Dog") {
        ...
        this.dataValue.dog.forEach(function (dogBreed) {
          htmlDogs + "<option value=\"".concat(dogBreed, "\">").concat(dogBreed, "</option>"), _readOnlyError("htmlDogs");
        });
        this.breedSelectTarget.innerHTML = htmlDogs;
      } else {
        this.breedSelectTarget.innerHTML = "\n      <option value=\"Siamese\">Siamese</option>\n      <option value=\"Maine Coon\">Maine Coon</option>\n      <option value=\"Gato Comum\">Gato Comum</option>\n    ";
      }
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-aaacf967654c8703ef8a.js.map