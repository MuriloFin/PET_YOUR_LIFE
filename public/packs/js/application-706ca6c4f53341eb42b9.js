    ...
    value: function connect() {
      ...
      this.channel = _channels_consumer__WEBPACK_IMPORTED_MODULE_1__["default"].subscriptions.create({
        ...
        received: function received(data) {
          return _this.insertMessageAndScrollDown(data);
        }
      });
    }
  }, {
    key: "insertMessageAndScrollDown",
    value: function insertMessageAndScrollDown(data) {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "selectPet",
    value: function selectPet() {
      if (this.petSelectTarget.value == "Cachorro") {
        var htmlDogs = '';
        this.dataValue.dog.forEach(function (dogBreed) {
          htmlDogs += "<option value=\"".concat(dogBreed, "\">").concat(dogBreed, "</option>");
        });
        this.breedSelectTarget.innerHTML = htmlDogs;
      } else {
        var htmlCats = '';
        this.dataValue.cat.forEach(function (catBreed) {
          htmlCats += "<option value=\"".concat(catBreed, "\">").concat(catBreed, "</option>");
        });
    ...
    key: "selectPetForm",
    value: function selectPetForm() {
      console.log(this.petSelectTarget.innerText);
...
_default.targets = ["petSelect", "breedSelect"];
_default.values = {
  data: Object
};
...
/******/ });
//# sourceMappingURL=application-706ca6c4f53341eb42b9.js.map